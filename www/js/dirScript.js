...
function updateMethods(methID){
	...
	}else{//closing all and unchecking
...
//function to set global lastUtt to selected level, update header buttons and continue, contUtt true if moving forward after selection, false to uncheck
function submitUttLevel(contUtt){ 
	...
	if(contUtt){
		if(!oneCheck){
			alert("Please select an utterance level.")
		}else{
